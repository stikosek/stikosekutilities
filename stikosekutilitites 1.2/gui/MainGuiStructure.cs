...
namespace stikosekutilitites_1._2.gui
{
	public class MainGuiStructure
	{
		...
		public static void SuDrawPlayer(int windowID)
		{
			...
			cheats.Player.godmode = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 20f, 150f, 20f), cheats.Player.godmode, "Godmode");
			cheats.Player.stamina = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 40f, 150f, 20f), cheats.Player.stamina, "Infinite stamina");
			cheats.Player.food = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 60f, 150f, 20f), cheats.Player.food, "infinite food");
			cheats.Player.instamine = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 80f, 150f, 20f),cheats.Player.instamine, "Instant mine");
			cheats.Player.instakill = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 100f, 150f, 20f), cheats.Player.instakill, "Instant kill");
			cheats.Player.freechests = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 120f, 150f, 20f), cheats.Player.freechests, "Free chests");
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuMovementRect, fontsize, "Movement");
			int SuPlayerButtonsXValue = 10;

			
			cheats.Movement.flight = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 20f, 150f, 20f), cheats.Movement.flight, "Flight");
			cheats.Movement.omegajump = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 40f, 150f, 20f), cheats.Movement.omegajump, "Omega jump");
			cheats.Movement.noclip = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 60f, 150f, 20f), cheats.Movement.noclip, "No clip");
			cheats.Movement.speed = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 80f, 150f, 20f), cheats.Movement.speed, "Speed");
			cheats.Movement.hover = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 100f, 150f, 20f), cheats.Movement.hover, "Hover");
			cheats.Movement.clicktp = GUI.Toggle(new Rect((float)SuPlayerButtonsXValue, 120f, 150f, 20f), cheats.Movement.clicktp, "Click tp");
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuServerRect, fontsize, "Player actions");
			...
			if (array[playerselectid].username == UnityEngine.Object.FindObjectOfType<PlayerManager>().username)
			{
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuExploitRect, fontsize, "Exploit");
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuItemRect, fontsize, "Item spawner");
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuPowerRect, fontsize, "Powerup spawner");
			...
			for (int i = 0; i < 1; i++)
			{
				...
				for (int j = 0; j < 4; j++)
				{
					float SuPwrY = (float)(j * 60 + 20);
					for (int k = 0; k < 7; k++)
					{
					float SuPwrX = (float)(k * 60 + 10);
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuMobRect, fontsize, "Mob spawner");
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuWorldRect, fontsize, "World");
		...
		{
			utils.DrawingUtilities.DrawWindowBackground(topcolor, restcolor, SuEspRect, fontsize, "Esp's");
