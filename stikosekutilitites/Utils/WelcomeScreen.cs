using UnityEngine;
using static su.Utils.DrawingUtilities;

namespace su.Utils
{
    public static class WelcomeScreen
    {
        public static KeyCode MenuBind;
        ...
        private static void DrawWelcome()
        {
            ...
            string waterMark = "<b>Stikosek's stikosekutilities 1.3</b>";
            ...
            DrawCenteredText(
            "Welcome to Stikosek's stikosekutilities 1.3" + "\n" +

            $"To open the ClickGUI press \"<b><color=red>{ KeyCodeFormatter.KeyNames[MenuBind] }</color></b>\"" + "\n" +
